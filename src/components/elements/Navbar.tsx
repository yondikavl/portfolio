    ...
    <>
      <div className="fixed z-10 flex w-full items-center justify-between p-6 text-[#BCBCBC] backdrop-blur-md lg:px-72">
        ...
        <div className="hidden gap-4 md:flex">
          <Link
            href="/work"
            className="flex min-h-12 min-w-20 items-center justify-center rounded-lg border border-[#3a3a3a] bg-[#0f0f0f] px-4 py-2 hover:bg-[#af9d55] hover:font-bold hover:text-[#0f0f0f]"
          >
            Work
          </Link>
          <Link
        ...
        <div className="flex items-center md:hidden">
          <button
            onClick={toggleMenu}
            className="rounded-lg border border-[#3a3a3a] bg-[#0f0f0f] p-2 text-2xl hover:bg-[#af9d55] hover:text-[#0f0f0f]"
          >
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-20 flex flex-col items-center justify-center bg-[#0f0f0f] md:hidden">
          ...
          <div className="flex w-full flex-col items-center justify-center gap-8 px-8">
            ...
            <Link
              href="/work"
              className="flex min-h-12 w-full items-center justify-center rounded-lg border border-[#3a3a3a] bg-[#0f0f0f] px-4 py-2 text-whitey hover:bg-[#af9d55] hover:font-bold hover:text-[#0f0f0f]"
              onClick={toggleMenu}
            >
              Work
            </Link>
